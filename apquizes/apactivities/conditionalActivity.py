...
"The parameter is a placeholder and the argument is the code used"
# 2. In your own words, describe what 
# a conditional statement (if/else) is 
"A if/else statement is a function"
# 3. write a simple conditional state using a comparision operator(greater than, less than, etc. )
goop = input("input an number ")
 if (goop = 10):
 print("The nuber you choose is equip to the true number")
else
   (print("Your number is less than or greater than the true number")
