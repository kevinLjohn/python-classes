...
"a situation where you'd use this is when you need to calculate something"
# 3. Describe the difference between camal case and pascal case.

#Camal case is "numberOfPeople" while pascal case is "NumberOfDeadpeople"
...
addedcash = 50.00
friend = 35.50
total = (str(friend + giftcord + addedcash))
print("You have $" + total + " cash in your account")
...
#The best varible to use here would be a if command and input

# 9. In your own words, describe what a program is?

#A program is a list of code that makes a device/website work

# 10. Describe the difference between a float and an integer. 

#a float is a decimal while a interger is a full number